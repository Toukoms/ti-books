...
const articles = [
  {
    ...
    excerpt:
      "Discover why it’s crucial to keep the tradition of Malagasy folktales alive and how Ti-Books contributes to this cause.",
  ...
  },
  {
    ...
    excerpt:
      "Learn how interactive storybooks can enhance English language learning for young Malagasy students.",
  ...
  },
  {
    ...
    excerpt:
      "Dive into the vibrant culture of Madagascar through its stories, customs, and traditions.",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-600 text-lg max-w-xl mx-auto">
            Explore our blog to learn more about Malagasy culture, language
            learning, and the stories behind Ti-Books.
          </p>
        </div>
        ...
        <div className="text-center mt-12 hidden">
          <Link
            href="/blog"
            className="text-white bg-green-500 hover:bg-green-600 font-semibold py-3 px-6 rounded-lg"
          >
