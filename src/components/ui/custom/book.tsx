...
const Book = (book: IBook) => {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden bg-gray-200 h-3/5">
        {loading ? (
          ...
          <Image
            ...
            priority
            className="transition-all duration-500 ease-in-out group-hover:brightness-75 group-hover:scale-110"
          />
        )}
      </div>
      <div className="p-4">
